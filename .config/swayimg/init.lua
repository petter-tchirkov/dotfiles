...
swayimg.text.set_font("SauceCodePro Nerd Font") -- font name
...
swayimg.text.set_background(0xff000000) -- text background color
...
-- Image viewer mode
swayimg.viewer.set_default_scale("height") -- default image scale
...
swayimg.viewer.on_key("s", function()
	...
	swayimg.viewer.set_abs_position(pos.x, pos.y - scroll_offset)
end)
...
swayimg.viewer.on_key("q", function()
	local pos = swayimg.viewer.get_position()
	swayimg.viewer.set_abs_position(pos.x + scroll_offset, pos.y)
end)
...
swayimg.slideshow.set_default_scale("keep") -- default image scale
...
swayimg.viewer.set_default_position("topleft")
